...
public class PersonalService {
     ...
     */
    public List<AlunoResponse> listarAlunosDoPersonal(Long personalId) {
     ...
     * (personalId IS NULL)
     */
    public List<AlunoResponse> listarAlunosDisponiveis() {
     ...
     */
    public AlunoResponse vincularAluno(VincularAlunoRequest request) {
    ...
    private AlunoResponse toAlunoDoPersonalResponse(Usuario aluno) {
